    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shucaiOrderUuidNumber" id="shucaiOrderUuidNumber" lay-verify="required" placeholder="订单号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shucaiOrderTruePrice" id="shucaiOrderTruePrice"  lay-verify="required|double"   placeholder="实付价格" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shucaiOrderCourierName" id="shucaiOrderCourierName" lay-verify="required" placeholder="快递公司" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shucaiOrderCourierNumber" id="shucaiOrderCourierNumber" lay-verify="required" placeholder="订单快递单号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="shucaiOrderTypes" id="shucaiOrderTypes">
                                    <option v-for="item in shucaiOrderTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="shucaiOrderPaymentTypes" id="shucaiOrderPaymentTypes">
                                    <option v-for="item in shucaiOrderPaymentTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`shucaiOrder/session`, 'get', {}, function (data) {
                    // 表单赋值
