            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">蔬菜退换货展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="shucaiTuihuanhuoUuidNumber" id="shucaiTuihuanhuoUuidNumber" placeholder="退换货编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="shucaiTuihuanhuoYesnoTypes" id="shucaiTuihuanhuoYesnoTypes" lay-filter="shucaiTuihuanhuoYesnoTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in shucaiTuihuanhuoYesnoTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function tuihuanhuoTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=tuihuanhuo_types", 'get', {}, function (res) {
                if(res.code == 0){
        ...
        function shucaiTuihuanhuoYesnoTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=shucai_tuihuanhuo_yesno_types", 'get', {}, function (res) {
                if(res.code == 0){
        ...
        function kuaidiTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=kuaidi_types", 'get', {}, function (res) {
                if(res.code == 0){
        ...
        function pageList() {
            ...
            if (jquery('#shucaiTuihuanhuoUuidNumber').val() != null && jquery('#shucaiTuihuanhuoUuidNumber').val() != "" && jquery('#shucaiTuihuanhuoUuidNumber').val() != "null" ) {
                param['shucaiTuihuanhuoUuidNumber'] = jquery('#shucaiTuihuanhuoUuidNumber').val();
            }
                         
            var tuihuanhuoTypes = $("#tuihuanhuoTypes").find("option:selected").val();
            if (tuihuanhuoTypes != null && tuihuanhuoTypes != "" && tuihuanhuoTypes != "null") {
                param['tuihuanhuoTypes'] = tuihuanhuoTypes;
            }
                         
            var shucaiTuihuanhuoYesnoTypes = $("#shucaiTuihuanhuoYesnoTypes").find("option:selected").val();
            if (shucaiTuihuanhuoYesnoTypes != null && shucaiTuihuanhuoYesnoTypes != "" && shucaiTuihuanhuoYesnoTypes != "null") {
                param['shucaiTuihuanhuoYesnoTypes'] = shucaiTuihuanhuoYesnoTypes;
            }
                                         
            var kuaidiTypes = $("#kuaidiTypes").find("option:selected").val();
            if (kuaidiTypes != null && kuaidiTypes != "" && kuaidiTypes != "null") {
                param['kuaidiTypes'] = kuaidiTypes;
            }
                        

            // 获取列表数据
            http.request('shucaiTuihuanhuo/list', 'get', param, function(res) {
