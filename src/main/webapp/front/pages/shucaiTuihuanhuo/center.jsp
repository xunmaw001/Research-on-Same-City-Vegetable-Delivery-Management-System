    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shucaiTuihuanhuoUuidNumber" id="shucaiTuihuanhuoUuidNumber" lay-verify="required" placeholder="退换货编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="tuihuanhuoTypes" id="tuihuanhuoTypes">
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="shucaiTuihuanhuoYesnoTypes" id="shucaiTuihuanhuoYesnoTypes">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shenheTime" id="shenheTime"  lay-verify="required|date"   placeholder="审核时间" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shucaiTuihuanhuoCourierName" id="shucaiTuihuanhuoCourierName" lay-verify="required" placeholder="退回快递公司" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shucaiTuihuanhuoCourierNumber" id="shucaiTuihuanhuoCourierNumber" lay-verify="required" placeholder="退回快递单号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="kuaidiTypes" id="kuaidiTypes">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shucaiHuanhuoCourierName" id="shucaiHuanhuoCourierName" lay-verify="required" placeholder="换货快递公司" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shucaiHuanhuoCourierNumber" id="shucaiHuanhuoCourierNumber" lay-verify="required" placeholder="换货快递单号" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`shucaiTuihuanhuo/session`, 'get', {}, function (data) {
                    // 表单赋值
