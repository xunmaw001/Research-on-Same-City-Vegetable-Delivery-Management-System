            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <section style="margin: 10px">
                        <div class="row">
                            <div v-for="(item,index) in shucaiList" class="col-md-3">
                                <div class="gallery-demo" @click="jumpCheck('../shucai/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                    <img :src="item.shucaiPhoto?item.shucaiPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                    <h4 class="p-mask">{{item.shucaiName}}
                                        <span v-if="item.shucaiNewMoney"> - ￥{{item.shucaiNewMoney}}</span>
                                        <span v-else-if="item.shucaiTypes"> - {{item.shucaiValue}}</span>
                                    </h4>
                                </div>
                            </div>
                        </div>
