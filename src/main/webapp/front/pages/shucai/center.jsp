    ...
    <ul id="category">
        <li v-for="(item,index) in centerMenu" v-bind:key="index" :class="index==0?'bbbb':''">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shucaiName" id="shucaiName" lay-verify="required" placeholder="蔬菜名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shucaiUuidNumber" id="shucaiUuidNumber" lay-verify="required" placeholder="蔬菜编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="shucaiPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="shucaiPhoto" name="shucaiPhoto"/>
							</div>
						</div>

						<div class="layui-form-item">
							<div class="layui-input-block">
								<button type="button" class="layui-btn btn-theme" id="shucaiPhotoUpload">
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="shucaiTypes" id="shucaiTypes">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shucaiKucunNumber" id="shucaiKucunNumber"  lay-verify="required|integer"   placeholder="蔬菜库存" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shucaiPrice" id="shucaiPrice"  lay-verify="required|integer"   placeholder="购买获得积分" autocomplete="off" class="layui-input">
							</div>
						</div>
			<div class="layui-form-item">
                <div class="layui-block">
                    <label class="layui-form-label">蔬菜原价</label>
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="shucaiOldMoney" id="shucaiOldMoney"  placeholder="蔬菜原价" autocomplete="off" class="layui-input" style="width: 500px">
			...
			<div class="layui-form-item">
                <div class="layui-block">
                    ...
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="shucaiNewMoney" id="shucaiNewMoney"  placeholder="现价" autocomplete="off" class="layui-input" style="width: 500px">
                        <div class="layui-form-mid layui-word-aux">
                            <i class="layui-icon" style="font-size: 20px;color: red;">&#xe65e;</i>
                            <a id="btn-recharge" href="javascript:void(0)">点我充值</a>
                        </div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shucaiClicknum" id="shucaiClicknum"  lay-verify="required|integer"   placeholder="蔬菜热度" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                upload.render({
                    ...
                    // 上传成功
                        ...
                        if (res.code == 0) {
                            ...
                            jquery('#shucaiPhoto').val(url);
                            jquery('#shucaiPhotoImg').attr('src', url);
                        } else {
                            layer.msg(res.msg, {
                                time: 2000,
                                icon: 5
                ...
                http.request(`shucai/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#shucaiPhotoImg").attr("src", data.data.shucaiPhoto);
                });
			   ...
			   function shucaiTypesSelect() {
				   //填充下拉框选项
				   http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=shucai_types", "GET", {}, (res) => {
					   if(res.code == 0){
