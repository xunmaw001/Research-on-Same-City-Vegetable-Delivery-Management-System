            ...
            <article>
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">经理编号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="jingliUuidNumber" id="jingliUuidNumber"  placeholder="经理编号"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">经理姓名:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="jingliName" id="jingliName"  placeholder="经理姓名"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
<!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">经理手机号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="jingliPhone" id="jingliPhone"  lay-verify="phone|required"   placeholder="经理手机号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
  <!-- 身份证号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">经理身份证号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="jingliIdNumber" id="jingliIdNumber"  lay-verify="identity|required"   placeholder="经理身份证号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                  <div class="layui-form-item layui-form-text input">
...
<!-- 邮箱 -->
                <div class="layui-form-item" pane>
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="jingliEmail" id="jingliEmail"  lay-verify="email|required"   placeholder="电子邮箱" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
