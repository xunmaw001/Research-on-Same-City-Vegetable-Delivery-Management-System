            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">经理展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="jingliUuidNumber" id="jingliUuidNumber" placeholder="经理编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="jingliName" id="jingliName" placeholder="经理姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#jingliUuidNumber').val() != null && jquery('#jingliUuidNumber').val() != "" && jquery('#jingliUuidNumber').val() != "null" ) {
                param['jingliUuidNumber'] = jquery('#jingliUuidNumber').val();
            }
         
            if (jquery('#jingliName').val() != null && jquery('#jingliName').val() != "" && jquery('#jingliName').val() != "null" ) {
                param['jingliName'] = jquery('#jingliName').val();
            }
                                                

            // 获取列表数据
            http.request('jingli/list', 'get', param, function(res) {
