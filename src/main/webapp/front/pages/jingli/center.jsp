    ...
    <ul id="category">
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="jingliUuidNumber" id="jingliUuidNumber" lay-verify="required" placeholder="经理编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="jingliName" id="jingliName" lay-verify="required" placeholder="经理姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="jingliPhone" id="jingliPhone"  lay-verify="required|phone"   placeholder="经理手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="jingliIdNumber" id="jingliIdNumber"  lay-verify="required|identity"   placeholder="经理身份证号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="jingliPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="jingliPhoto" name="jingliPhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="jingliEmail" id="jingliEmail"  lay-verify="required|email"   placeholder="电子邮箱" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`jingli/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#jingliPhotoImg").attr("src", data.data.jingliPhoto);
                });
