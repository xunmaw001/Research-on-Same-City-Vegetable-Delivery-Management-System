...
var centerMenu = [
    ...
    ,{
        name: '蔬菜收藏',
        url: '../shucaiCollection/list.jsp'
    }
    ,{
        name: '蔬菜订单',
        url: '../shucaiOrder/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '蔬菜',
        url: './pages/shucai/list.jsp'
    },

]

var adminurl =  "http://localhost:8080/tongchengshucaipeisong/jsp/login.jsp";
