    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑蔬菜收藏</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">蔬菜收藏管理</li>
                        <li class="breadcrumb-item active">编辑蔬菜收藏</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">蔬菜收藏信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6 shucaiCollectionTypesDiv">
                                        <label>类型</label>
                                        <select style="width: 450px" id="shucaiCollectionTypesSelect" name="shucaiCollectionTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    var tableName = "shucaiCollection";
    ...
    // 下拉框数组
        <!-- 当前表的下拉框数组 -->
    var shucaiCollectionTypesOptions = [];
        <!-- 级联表的下拉框数组 -->
    var shucaiOptions = [];
    var yonghuOptions = [];
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("shucaiCollection/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addshucaiCollection');
    ...
    // 查询列表
        ...
        function shucaiCollectionTypesSelect() {
            //填充下拉框选项
            http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=shucai_collection_types", "GET", {}, (res) => {
                if(res.code == 0){
                    shucaiCollectionTypesOptions = res.data.list;
                }
            });
        }
        <!-- 查询级联表的所有列表 -->
    ...
    // 初始化下拉框
    <!-- 初始化当前表的下拉框 -->
        function initializationShucaicollectiontypesSelect(){
            var shucaiCollectionTypesSelect = document.getElementById('shucaiCollectionTypesSelect');
            if(shucaiCollectionTypesSelect != null && shucaiCollectionTypesOptions != null  && shucaiCollectionTypesOptions.length > 0 ){
                for (var i = 0; i < shucaiCollectionTypesOptions.length; i++) {
                    shucaiCollectionTypesSelect.add(new Option(shucaiCollectionTypesOptions[i].indexName,shucaiCollectionTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(shucaiCollectionTypesSelect != null && shucaiCollectionTypesOptions != null  && shucaiCollectionTypesOptions.length > 0 ) {
            for (var i = 0; i < shucaiCollectionTypesOptions.length; i++) {
                if (shucaiCollectionTypesOptions[i].codeIndex == ruleForm.shucaiCollectionTypes) {//下拉框value对比,如果一致就赋值汉字
                        shucaiCollectionTypesSelect.options[i].selected = true;
                }
            }
        }
        <!--  级联表的下拉框回显  -->
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                shucaiId: "required",
                yonghuId: "required",
                shucaiCollectionTypes: "required",
            },
            messages: {
                shucaiId: "蔬菜不能为空",
                yonghuId: "用户不能为空",
                shucaiCollectionTypes: "类型不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addshucaiCollection = window.sessionStorage.getItem("addshucaiCollection");
        if (addshucaiCollection != null && addshucaiCollection != "" && addshucaiCollection != "null") {
            //注册表单验证
            $(validform());
            ...
            window.sessionStorage.removeItem('updateId');
            http("shucaiCollection/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            <!--  初始化当前表的下拉框  -->
            initializationShucaicollectiontypesSelect();
            <!--  初始化级联表的下拉框  -->
