            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">蔬菜订单登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="shucaiId" name="shucaiId" v-model="ruleForm.shucaiId" readonly type="hidden">
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="shucaiOrderTruePrice" name="shucaiOrderTruePrice" class="form-control"
                                               v-model="ruleForm.shucaiOrderTruePrice" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="shucaiOrderCourierName" name="shucaiOrderCourierName" class="form-control"
                                               v-model="ruleForm.shucaiOrderCourierName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="shucaiOrderCourierNumber" name="shucaiOrderCourierNumber" class="form-control"
                                               v-model="ruleForm.shucaiOrderCourierNumber" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>支付类型</label>
                                    <input style="width: 450px" id="shucaiOrderPaymentValue" name="shucaiOrderPaymentValue" class="form-control"
                                           v-model="ruleForm.shucaiOrderPaymentValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "shucaiOrder/info/" + id,
