            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">蔬菜退换货登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="shucaiOrderUuidNumber" name="shucaiOrderUuidNumber" class="form-control"
                                                   v-model="ruleForm.shucaiOrderUuidNumber" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="shucaiOrderValue" name="shucaiOrderValue" class="form-control"
                                               v-model="ruleForm.shucaiOrderValue" readonly>
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="shucaiTuihuanhuoUuidNumber" name="shucaiTuihuanhuoUuidNumber" class="form-control"
                                               v-model="ruleForm.shucaiTuihuanhuoUuidNumber" readonly>
                                    </div>

                                <input id="shucaiOrderId" name="shucaiOrderId" v-model="ruleForm.shucaiOrderId" readonly type="hidden">
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">

                                <div class="form-group col-md-6">
                                    <label>退换货</label>
                                    <input style="width: 450px" id="tuihuanhuoValue" name="tuihuanhuoValue" class="form-control"
                                           v-model="ruleForm.tuihuanhuoValue" readonly>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>审核状态</label>
                                    <input style="width: 450px" id="shucaiTuihuanhuoYesnoValue" name="shucaiTuihuanhuoYesnoValue" class="form-control"
                                           v-model="ruleForm.shucaiTuihuanhuoYesnoValue" readonly>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>审核时间</label>
                                        <input style="width: 450px" id="shenheTime" name="shenheTime" class="form-control"
                                               v-model="ruleForm.shenheTime" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="shucaiTuihuanhuoCourierName" name="shucaiTuihuanhuoCourierName" class="form-control"
                                               v-model="ruleForm.shucaiTuihuanhuoCourierName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="shucaiTuihuanhuoCourierNumber" name="shucaiTuihuanhuoCourierNumber" class="form-control"
                                               v-model="ruleForm.shucaiTuihuanhuoCourierNumber" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="shucaiHuanhuoCourierName" name="shucaiHuanhuoCourierName" class="form-control"
                                               v-model="ruleForm.shucaiHuanhuoCourierName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="shucaiHuanhuoCourierNumber" name="shucaiHuanhuoCourierNumber" class="form-control"
                                               v-model="ruleForm.shucaiHuanhuoCourierNumber" readonly>
                                    </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "shucaiTuihuanhuo/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.shucaiTuihuanhuoYesnoContent != null && ruleForm.shucaiTuihuanhuoYesnoContent != 'null' && ruleForm.shucaiTuihuanhuoYesnoContent != '') {
            var shucaiTuihuanhuoYesnoContentUeditor = UE.getEditor('shucaiTuihuanhuoYesnoContentEditor');
                shucaiTuihuanhuoYesnoContentUeditor.ready(function () {
                    ...
                    shucaiTuihuanhuoYesnoContentUeditor.setDisabled('fullscreen');
            });
        }
    }
