 ...
 */
@TableName("shucai")
public class ShucaiEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Shucai{" +
            "id=" + id +
            ", shucaiName=" + shucaiName +
            ", shucaiUuidNumber=" + shucaiUuidNumber +
            ", shucaiPhoto=" + shucaiPhoto +
            ", shucaiTypes=" + shucaiTypes +
            ", shucaiKucunNumber=" + shucaiKucunNumber +
            ", shucaiPrice=" + shucaiPrice +
            ", shucaiOldMoney=" + shucaiOldMoney +
            ", shucaiNewMoney=" + shucaiNewMoney +
            ", shucaiClicknum=" + shucaiClicknum +
            ", shucaiContent=" + shucaiContent +
            ", shangxiaTypes=" + shangxiaTypes +
            ", shucaiDelete=" + shucaiDelete +
