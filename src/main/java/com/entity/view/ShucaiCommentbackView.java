...
public class ShucaiCommentbackView extends ShucaiCommentbackEntity implements Serializable {
	...
	public ShucaiCommentbackView() {

	}

	public ShucaiCommentbackView(ShucaiCommentbackEntity shucaiCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, shucaiCommentbackEntity);
