...
public class ShucaiOrderView extends ShucaiOrderEntity implements Serializable {
	...
	public ShucaiOrderView() {

	}

	public ShucaiOrderView(ShucaiOrderEntity shucaiOrderEntity) {
		try {
			BeanUtils.copyProperties(this, shucaiOrderEntity);
