...
public class ShucaiCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ShucaiCollectionEntity() {

	}

	public ShucaiCollectionEntity(T t) {
		try {
    ...
    public String toString() {
        return "ShucaiCollection{" +
            "id=" + id +
            ", shucaiId=" + shucaiId +
            ", yonghuId=" + yonghuId +
            ", shucaiCollectionTypes=" + shucaiCollectionTypes +
